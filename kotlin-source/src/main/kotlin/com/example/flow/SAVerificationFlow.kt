...
object SAVerificationFlow {
    ...
    class Initiator(val sano: String, val saState: String) : FlowLogic<SignedTransaction>() {
        ...
        override fun call(): SignedTransaction {
            ...
            val acceptCommand = Command(SAContract.Commands.Accept(), signers)
            ...
            builder.withItems(inputStateAndRef,
                    StateAndContract(outputSA, SAContract.SA_CONTRACT_ID),
                    acceptCommand)
            val counterParty =  inState.buyer
    ...
    @InitiatedBy(SAVerificationFlow.Initiator::class)
