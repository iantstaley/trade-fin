...
/**
 * This flow allows two buyers (the [Initiator] and the [Acceptor]) to come to an agreement about the IOU encapsulated
 * within an [IOUState].
 *
...
object ExampleFlow {
    ...
    class Initiator(val iouValue: Int,
        ...
        override fun call(): SignedTransaction {
            ...
            // Notarise and record the transaction in both buyers' vaults.
